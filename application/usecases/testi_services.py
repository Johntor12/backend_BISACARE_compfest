...
from schemas.testi_schema import TestiRequest

class TestiService:
    def __init__(self, testi_repository: TestiRepository):
        self.testi_repository = testi_repository

    async def create_testi(self, testi: TestiRequest):
    ...
    async def update_testi(self, testi_id: int, testi: TestiRequest):
