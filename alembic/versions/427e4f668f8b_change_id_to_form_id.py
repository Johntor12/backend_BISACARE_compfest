"""change id to form_id

Revision ID: 427e4f668f8b
Revises: b9e806752ef0
Create Date: 2025-08-18 13:08:11.993611
...
revision: str = '427e4f668f8b'
down_revision: Union[str, Sequence[str], None] = 'b9e806752ef0'
...
def upgrade() -> None:
    ...
    op.drop_index(op.f('ix_insurance_forms_id'), table_name='insurance_forms')
...
def downgrade() -> None:
    ...
    sa.Column('other_service', sa.VARCHAR(length=255), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name=op.f('insurance_forms_pkey'))
    )
    op.create_index(op.f('ix_insurance_forms_id'), 'insurance_forms', ['id'], unique=False)
