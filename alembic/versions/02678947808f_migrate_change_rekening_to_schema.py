"""migrate change rekening to schema

Revision ID: 02678947808f
Revises: d9ff25869a8a
Create Date: 2025-09-21 12:31:49.713003
...
revision: str = '02678947808f'
down_revision: Union[str, Sequence[str], None] = 'd9ff25869a8a'
...
def downgrade() -> None:
    ...
    sa.Column('rekening_number', sa.VARCHAR(), autoincrement=False, nullable=True),
