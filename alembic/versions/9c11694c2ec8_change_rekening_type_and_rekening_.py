"""change rekening type and rekening number to insuranceform

Revision ID: 9c11694c2ec8
Revises: 1a606671673b
Create Date: 2025-09-21 12:14:39.073822
...
revision: str = '9c11694c2ec8'
down_revision: Union[str, Sequence[str], None] = '1a606671673b'
...
def downgrade() -> None:
    ...
    sa.Column('rekening_type', postgresql.ENUM('BCA', 'MANDIRI', 'BNI', 'BRI', 'CIMB_NIAGA', 'PERMATA_BANK', 'BANK_DANAMON', name='rekeningtypeenum'), autoincrement=False, nullable=True),
    sa.Column('rekening_number', sa.VARCHAR(), autoincrement=False, nullable=False),
